...
export const WorkerPassportPage: React.FC = () => {
  return (
    <div className="max-w-xl mx-auto py-12 px-6 bg-slate-900/60 border border-slate-800 rounded-2xl shadow-xl text-center space-y-4">
      ...
      <h2 className="text-2xl font-bold text-white">Credit Passport</h2>
      <p className="text-xs text-slate-400">
        Placeholder for generated Credit Passport credentials and consent audit sharing.
      </p>
      <div className="p-3 bg-slate-950/80 rounded-lg text-xs font-mono text-slate-500">
        Route: /worker/passport
      </div>
    </div>
  );
};
