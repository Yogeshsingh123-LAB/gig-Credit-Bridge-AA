...
def test_aggregate_monthly_expenses(normalized_synthetic):
    ...
    assert expenses["2026-03"] == 1200.0  # Fuel debit
    assert "2026-04" in expenses
    assert expenses["2026-04"] == 2500.0  # Maintenance debit
